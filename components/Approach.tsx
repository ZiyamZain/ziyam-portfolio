...
Based on the approved design, I'll translate everything into functional code, building your website from the ground up."
        title="Development and Launch" icon={<AceternityIcon order="Phase 3" />}>
          <CanvasRevealEffect
            animationSpeed={3}
